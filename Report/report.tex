...
Nos analyses confirment l'universalité des propriétés de \textit{Small World} et l'existence d'une structure hiérarchique au sein de ces graphes, tout en soulignant l'impact déterminant de la taille du réseau sur sa densité. La chute drastique de connectivité observée, passant de 5.7\% pour les petits campus à 1.2\% pour les grandes universités, illustre empiriquement les limites cognitives de sociabilisation théorisées par le nombre de Dunbar. Sur le plan algorithmique, nous avons démontré qu'aucune métrique de prédiction de liens ne s'impose universellement : la performance dépend intrinsèquement de la topologie locale, favorisant \textit{Common Neighbors} dans les communautés denses et \textit{Jaccard} dans les graphes dispersés dominés par des \textit{hubs}.
